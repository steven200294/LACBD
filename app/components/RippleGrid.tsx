...
void main() {
    ...
    const render = (t: number) => {
      ...
      uniforms.mouseInfluence.value += (mouseInfluenceRef.current - currentInfluence) * 0.05;
  ...
  }, [enableRainbow, gridColor, rippleIntensity, gridSize, gridThickness, fadeDistance,
      vignetteStrength, glowIntensity, opacity, gridRotation, mouseInteraction, mouseInteractionRadius]);
